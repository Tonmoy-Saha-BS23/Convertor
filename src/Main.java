...
public class Main {
    ...
    public static JPanel TemperaturePanelAdder(){
        ...
        textField1.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                TemperatureActionHandler(jComboBox1, jComboBox2, textField1, textField2);
            }
        });
    ...
    public static void TemperatureActionHandler(JComboBox jComboBox1, JComboBox jComboBox2, JTextField textField1, JTextField textField2){
...
//        panel.setBackground(Color.DARK_GRAY);
        ...
        textField1.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                CurrencyActionHandler(jComboBox1, jComboBox2, textField1, textField2);
            }
        });
        jComboBox1.addActionListener(new ActionListener() {
            @Override
    ...
    public static void CurrencyActionHandler(JComboBox jComboBox1, JComboBox jComboBox2, JTextField textField1, JTextField textField2){
        String type1 = (String) jComboBox1.getItemAt(jComboBox1.getSelectedIndex());
        String type2 = (String) jComboBox2.getItemAt(jComboBox2.getSelectedIndex());
        if(!type1.equals(type2)){
            if(type1.equals("BDT")){
